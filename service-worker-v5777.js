const CACHE_NAME='racehub-v5.7.77-production-conformance';
const ASSETS=[
  './',
  './index.html',
  './style-v5777.css?v=5777',
  './manifest.webmanifest?v=5777',
  './favicon.png',
  './js/seed-data.js?v=5777',
  './js/core.js?v=5777',
  './js/race-director.js?v=5777',
  './js/views.js?v=5777',
  './js/celebrations.js?v=5777',
  './js/garage.js?v=5777',
  './js/control-centre.js?v=5777',
  './js/studio-final-v5777.js?v=5777',
