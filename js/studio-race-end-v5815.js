/* RaceHub v5.8.15 — authoritative race-end flow (Result Summary + Final Standings). */
(()=>{
  'use strict';
  ...
  window.rhShowFinalStandingsV5815=showFinalRun;
  window.rhShowEventFinalStandingsV5815=showFinalEvent;
