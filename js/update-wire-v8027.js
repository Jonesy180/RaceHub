/* OTG! v8.0.27 — manifest-led, Safety-Backup-gated updater */
(()=>{
'use strict';
const CURRENT=()=>document.querySelector('meta[name="racehub-version"]')?.content||'8.0.27';
...
function createAndVerifyAllSpaceSafetyBackups(){
 try{
  // v8.0.27: persisted storage is the authority for backup slots.
