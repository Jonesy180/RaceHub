/* RaceHub v5.8.13 — authoritative race-end flow (Result Summary + Final Standings). */
(()=>{
  'use strict';
  ...
  window.rhShowFinalStandingsV5813=showFinalRun;
  window.rhShowEventFinalStandingsV5813=showFinalEvent;
