...
if('serviceWorker' in navigator){window.addEventListener('load',()=>navigator.serviceWorker.register('./service-worker-v5781.js',{updateViaCache:'none'}).catch(()=>{}));}


// RaceHub v5.7.81 — native touch-scroll containment.
