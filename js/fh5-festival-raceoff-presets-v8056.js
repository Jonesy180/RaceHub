...
/* Race Off catalogue gets the same Rally / Hot Wheels / Drag families. */
...
function injectRaceOffSpecialists(){
  ...
  target.insertAdjacentHTML('beforebegin',
   ...
   familyRaceOffHtml('fh5-drag','DRAG RACING RACE OFFS',D.drag));
}
