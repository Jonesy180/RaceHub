...
if('serviceWorker' in navigator){window.addEventListener('load',()=>navigator.serviceWorker.register('./service-worker-v5780.js',{updateViaCache:'none'}).catch(()=>{}));}


// RaceHub v5.7.80 — native touch-scroll containment.
