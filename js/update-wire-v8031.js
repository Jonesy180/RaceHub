/* OTG! v8.0.31 — manifest-led, Safety-Backup-gated updater */
(()=>{
'use strict';
const CURRENT=()=>document.querySelector('meta[name="racehub-version"]')?.content||'8.0.31';
...
function createAndVerifyAllSpaceSafetyBackups(){
 try{
  // v8.0.31: persisted storage is the authority for backup slots.
