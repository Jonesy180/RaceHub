/* OTG! v6.0.110 — deterministic catalogue identity repair; Festival data is never reset during startup reconciliation. */
(()=>{
'use strict';
const FH5_KEY='fh5-catalogue-v1', GT7_KEY='gt7-catalogue-v1', REPAIR_VERSION='6.0.110';
...
function repairSpace(s){
 ...
 // Festival runs/results are user data. Catalogue reconciliation must never delete or recreate them.
