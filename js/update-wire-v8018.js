/* OTG! v8.0.18 — manifest-led, Safety-Backup-gated updater */
(()=>{
'use strict';
const CURRENT=()=>document.querySelector('meta[name="racehub-version"]')?.content||'8.0.18';
...
function close(){document.getElementById('rhUpdateAvailable8018')?.remove();}
...
window.rhAutoCheckForUpdateV8018=()=>check(false);
})();
