// RaceHub v5.2.3 — Polish & Presentation
...
function freshState(){return migrateState({version:'5.2.3',cars:[...SEED.cars],events:[...SEED.events],results:[],history:[],recordHistory:[],lastRun:null,currentEventId:'drag',settings:{sound:true,confetti:true,vibrate:true}})}
...
function render(screen){ if(screen==='festival')renderFestival(); if(screen==='events')renderEvents(); if(screen==='event')renderEvent(); if(screen==='garage')renderGarage(); if(screen==='hall')renderHallOfFame(); if(screen==='more')renderMore(); }
