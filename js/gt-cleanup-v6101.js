/* OTG! v6.0.101 — space-isolated catalogue manufacturer rename. */
(()=>{'use strict';
...
window.rhGT101SaveRename=function(spaceId,oldMake){saveRename(decodeURIComponent(spaceId),decodeURIComponent(oldMake),q('rhGT101RenameInput')?.value)};
...
window.RACEHUB_VERSION='6.0.101';
})();
