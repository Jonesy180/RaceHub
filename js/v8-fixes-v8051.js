...
function swissPlannerHtml(){
  ...
  if(!p)return `<section class="rhSetupPanelV1 rhSwissPlanner8040 v8051SwissPlanner"><div class="rhEventSectionHead"><div><h2>Swiss Structure</h2><p class="small">Swiss is available for 8–32 entrants.</p></div><span class="rhFormatBadge8025">SWISS</span></div><div class="empty">Choose between 8 and 32 cars to enable Swiss.</div></section>`;
