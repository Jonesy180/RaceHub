 ...
 $('more').innerHTML=`<div class="statsPage">
  <section class="statsHero">
   ...
   <div class="statsHeadlineGrid">
    ...
    <div class="statsHeadline purple"><span>Championships</span><b>${champs.completed}</b><small>${champs.active} currently active</small></div>
