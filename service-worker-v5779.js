const CACHE_NAME='racehub-v5.7.79-touch-scroll-containment';
const ASSETS=[
  './',
  './index.html',
  './style-v5779.css?v=5779',
  './manifest.webmanifest?v=5779',
  './favicon.png',
  './js/seed-data.js?v=5779',
  './js/core.js?v=5779',
  './js/race-director.js?v=5779',
  './js/views.js?v=5779',
  './js/celebrations.js?v=5779',
  './js/garage.js?v=5779',
  './js/control-centre.js?v=5779',
  './js/studio-final-v5779.js?v=5779',
  './js/studio-locked-ui-v5779.js?v=5779',
  './js/studio-polish-v5779.js?v=5779',
  './js/bootstrap-v5779.js?v=5779',
