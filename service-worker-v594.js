const CACHE_NAME='racehub-v5.9.4-universal-back-no-memory-lists';
const ASSETS=[
  './','./index.html','./style-v594.css?v=594','./manifest.webmanifest?v=5829','./favicon.png',
  ...
  './js/studio-race-flow-v5809.js?v=5829','./js/bootstrap-v594.js?v=594','./js/studio-race-end-v5837.js?v=5837',
