const CACHE_NAME='racehub-v5.7.89-authoritative-settings-version';
const ASSETS=[
  './',
  './index.html',
  './style-v5789.css?v=5789',
  './manifest.webmanifest?v=5789',
  './favicon.png',
  './js/seed-data.js?v=5789',
  './js/core.js?v=5789',
  './js/race-director.js?v=5789',
  './js/views.js?v=5789',
  './js/celebrations.js?v=5789',
  './js/garage.js?v=5789',
  './js/control-centre.js?v=5789',
  './js/studio-final-v5780.js?v=5789',
  './js/studio-locked-ui-v5780.js?v=5789',
  './js/studio-polish-v5782.js?v=5789',
  './js/studio-release-v5789.js?v=5789',
  './js/studio-release-v5788.js?v=5789',
  './js/bootstrap-v5789.js?v=5789',
