const CACHE_NAME='racehub-v5.7.88-locked-final-standings-artwork';
const ASSETS=[
  './',
  './index.html',
  './style-v5788.css?v=5788',
  './manifest.webmanifest?v=5788',
  './favicon.png',
  './js/seed-data.js?v=5788',
  './js/core.js?v=5788',
  './js/race-director.js?v=5788',
  './js/views.js?v=5788',
  './js/celebrations.js?v=5788',
  './js/garage.js?v=5788',
  './js/control-centre.js?v=5788',
  './js/studio-final-v5780.js?v=5788',
  './js/studio-locked-ui-v5780.js?v=5788',
  './js/studio-polish-v5782.js?v=5788',
  './js/studio-release-v5783.js?v=5788',
  './js/studio-release-v5788.js?v=5788',
  './js/bootstrap-v5788.js?v=5788',
