const CACHE_NAME='racehub-v5.7.90-authoritative-settings-version';
const ASSETS=[
  './',
  './index.html',
  './style-v5790.css?v=5790',
  './manifest.webmanifest?v=5790',
  './favicon.png',
  './js/seed-data.js?v=5790',
  './js/core.js?v=5790',
  './js/race-director.js?v=5790',
  './js/views.js?v=5790',
  './js/celebrations.js?v=5790',
  './js/garage.js?v=5790',
  './js/control-centre.js?v=5790',
  './js/studio-final-v5780.js?v=5790',
  './js/studio-locked-ui-v5780.js?v=5790',
  './js/studio-polish-v5782.js?v=5790',
  './js/studio-release-v5790.js?v=5790',
  './js/studio-release-v5788.js?v=5790',
  './js/bootstrap-v5790.js?v=5790',
