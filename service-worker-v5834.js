const CACHE_NAME='racehub-v5.8.34-championship-overview-locked-master';
const ASSETS=[
  './','./index.html','./style-v5834.css?v=5834','./manifest.webmanifest?v=5829','./favicon.png',
  ...
  './js/studio-champ-overview-v5834.js?v=5834','./assets/final/championship-in-progress-aerial-v5834.png?v=5834',
