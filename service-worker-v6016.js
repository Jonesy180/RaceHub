const CACHE_NAME='racehub-v6.0.16-stage8b-lap-separator-alignment';
const ASSETS=[
  './','./index.html','./style-v595.css?v=6016','./manifest.webmanifest?v=6000','./favicon.png',
  './js/seed-data.js?v=5799','./js/core.js?v=6016','./js/race-director.js?v=5799','./js/views.js?v=5799',
  './js/celebrations.js?v=5799','./js/garage.js?v=5799','./js/control-centre.js?v=5799',
  './js/studio-final-v5808.js?v=6016','./js/studio-locked-ui-v5780.js?v=5799','./js/studio-polish-v5782.js?v=5799',
  './js/studio-v6-garage-foundation-v600.js?v=6016','./js/studio-release-v595.js?v=6016','./js/studio-enter-result-v5803.js?v=5803','./js/studio-result-summary-v5837.js?v=5837',
