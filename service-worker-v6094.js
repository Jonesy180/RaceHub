const CACHE_NAME='racehub-v6.0.94-grand-tour-final-fixes';
const ASSETS=[
  ...
  './','./index.html','./style-v6093.css','./js/grand-tour-polish-v6093.js','./js/grand-tour-final-fixes-v6094.js','./style-v595.css?v=6020','./manifest.webmanifest?v=6000','./favicon.png',
