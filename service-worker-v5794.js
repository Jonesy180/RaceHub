const CACHE_NAME='racehub-v5.7.94-final-standings-hard-isolation';
const ASSETS=[
  './',
  './index.html',
  './style-v5794.css?v=5794',
  './manifest.webmanifest?v=5794',
  './favicon.png',
  './js/seed-data.js?v=5794',
  './js/core.js?v=5794',
  './js/race-director.js?v=5794',
  './js/views.js?v=5794',
  './js/celebrations.js?v=5794',
  './js/garage.js?v=5794',
  './js/control-centre.js?v=5794',
  './js/studio-final-v5780.js?v=5794',
  './js/studio-locked-ui-v5780.js?v=5794',
  './js/studio-polish-v5782.js?v=5794',
  './js/studio-release-v5789.js?v=5794',
  './js/studio-release-v5787.js?v=5794',
  './js/studio-release-v5788.js?v=5794',
  './js/studio-release-v5790.js?v=5794',
  './js/studio-release-v5791.js?v=5794',
  './js/studio-release-v5794.js?v=5794',
  './js/bootstrap-v5794.js?v=5794',
