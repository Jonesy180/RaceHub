const CACHE_NAME='racehub-v5.7.84-locked-leaderboard-animations';
const ASSETS=[
  './',
  './index.html',
  './style-v5784.css?v=5784',
  './manifest.webmanifest?v=5784',
  './favicon.png',
  './js/seed-data.js?v=5784',
  './js/core.js?v=5784',
  './js/race-director.js?v=5784',
  './js/views.js?v=5784',
  './js/celebrations.js?v=5784',
  './js/garage.js?v=5784',
  './js/control-centre.js?v=5784',
  './js/studio-final-v5780.js?v=5784',
  './js/studio-locked-ui-v5780.js?v=5784',
  './js/studio-polish-v5782.js?v=5784',
  './js/studio-release-v5783.js?v=5784',
  './js/studio-release-v5784.js?v=5784',
  './js/bootstrap-v5784.js?v=5784',
