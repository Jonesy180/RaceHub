const CACHE_NAME='racehub-v5.8.08-version-sync';
const ASSETS=[
  './','./index.html','./style-v5808.css?v=5808','./manifest.webmanifest?v=5808','./favicon.png',
  ...
  './js/studio-release-v5808.js?v=5808','./js/studio-enter-result-v5803.js?v=5803','./js/studio-result-summary-v5804.js?v=5804','./js/bootstrap-v5808.js?v=5808',
