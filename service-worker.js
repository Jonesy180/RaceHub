const CACHE_NAME='racehub-v6.0.93-grand-tour-polish';
const ASSETS=[
  ...
  './','./index.html','./style-v6093.css','./js/grand-tour-polish-v6093.js','./style-v595.css?v=6020','./manifest.webmanifest?v=6000','./favicon.png',
