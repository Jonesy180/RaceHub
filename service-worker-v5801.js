const CACHE_NAME='racehub-v5.8.01-final-standings-hard-isolation';
const ASSETS=[
  './',
  './index.html',
  './style-v5801.css?v=5801',
  './manifest.webmanifest?v=5801',
  './favicon.png',
  './js/seed-data.js?v=5801',
  './js/core.js?v=5801',
  './js/race-director.js?v=5801',
  './js/views.js?v=5801',
  './js/celebrations.js?v=5801',
  './js/garage.js?v=5801',
  './js/control-centre.js?v=5801',
  './js/studio-final-v5780.js?v=5801',
  './js/studio-locked-ui-v5780.js?v=5801',
  './js/studio-polish-v5782.js?v=5801',
  './js/studio-release-v5789.js?v=5801',
  './js/studio-release-v5787.js?v=5801',
  './js/studio-release-v5788.js?v=5801',
  './js/studio-release-v5790.js?v=5801',
  './js/studio-release-v5791.js?v=5801',
  './js/studio-release-v5801.js?v=5801',
  './js/bootstrap-v5801.js?v=5801',
  './assets/brand/otg-mark-painted-wall.svg',
  './assets/final/post-race-finish-background-v5780.png',
  './assets/final/enter-result-finish-line-hero-v5781.png','./assets/final/enter-result-side-finish-v5801.png',
