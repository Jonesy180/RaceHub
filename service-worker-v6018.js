const CACHE_NAME='racehub-v6.0.18-stage9a-league-foundation';
const ASSETS=[
  ...
  './style-v6018.css?v=6018','./js/studio-v6-league-foundation-v6018.js?v=6018','./assets/final/league-organiser-control-room-v6018.png','./icons/icon-v5765-192.png','./icons/icon-v5765-512.png'
];
