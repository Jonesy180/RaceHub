const CACHE_NAME='racehub-v5.8.03-enter-result-locked';
const ASSETS=[
  './','./index.html','./style-v5803.css?v=5803','./manifest.webmanifest?v=5803','./favicon.png',
  ...
  './assets/final/racehub-logo.png','./assets/final/enter-result-side-finish-v5803.png',
