const CACHE_NAME='racehub-v5.8.33-championship-overview-rebuild';
const ASSETS=[
  './','./index.html','./style-v5833.css?v=5833','./manifest.webmanifest?v=5829','./favicon.png',
  ...
  './js/studio-champ-overview-v5833.js?v=5833','./assets/final/championship-in-progress-aerial-v5833.png?v=5833',
