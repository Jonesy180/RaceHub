const CACHE_NAME='racehub-v5.7.87-locked-official-results';
const ASSETS=[
  './',
  './index.html',
  './style-v5787.css?v=5787',
  './manifest.webmanifest?v=5787',
  './favicon.png',
  './js/seed-data.js?v=5787',
  './js/core.js?v=5787',
  './js/race-director.js?v=5787',
  './js/views.js?v=5787',
  './js/celebrations.js?v=5787',
  './js/garage.js?v=5787',
  './js/control-centre.js?v=5787',
  './js/studio-final-v5780.js?v=5787',
  './js/studio-locked-ui-v5780.js?v=5787',
  './js/studio-polish-v5782.js?v=5787',
  './js/studio-release-v5783.js?v=5787',
  './js/studio-release-v5787.js?v=5787',
  './js/bootstrap-v5787.js?v=5787',
