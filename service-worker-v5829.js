const CACHE_NAME='racehub-v5.8.29-hubs-celebration';
const ASSETS=[
  './','./index.html','./style-v5829.css?v=5829','./manifest.webmanifest?v=5829','./favicon.png',
  ...
  './js/studio-final-standings-v5828.js?v=5829','./assets/final/final-standings-face-on-ui-ready-v5828.png?v=5828',
