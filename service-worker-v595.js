const CACHE_NAME='racehub-v5.9.17-universal-back-size';
const ASSETS=[
  './','./index.html','./style-v595.css?v=5917','./manifest.webmanifest?v=5829','./favicon.png',
  ...
  './js/studio-release-v595.js?v=5917','./js/studio-enter-result-v5803.js?v=5803','./js/studio-result-summary-v5837.js?v=5837',
  ...
  './js/studio-champ-overview-v5835.js?v=5835','./js/studio-beta-feedback-v595.js?v=5917','./assets/final/championship-in-progress-aerial-v5834.png?v=5834',
