const CACHE_NAME='racehub-v5.9.18-festival-events-back-size-authority';
const ASSETS=[
  './','./index.html','./style-v595.css?v=5918','./manifest.webmanifest?v=5829','./favicon.png',
  ...
  './js/studio-release-v595.js?v=5918','./js/studio-enter-result-v5803.js?v=5803','./js/studio-result-summary-v5837.js?v=5837',
