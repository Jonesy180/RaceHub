...
const ASSETS=[
  './',
  './index.html',
  './style-v5802.css?v=5802',
  './manifest.webmanifest?v=5802',
  './favicon.png',
  './js/seed-data.js?v=5802',
  './js/core.js?v=5802',
  './js/race-director.js?v=5802',
  './js/views.js?v=5802',
  './js/celebrations.js?v=5802',
  './js/garage.js?v=5802',
  './js/control-centre.js?v=5802',
  './js/studio-final-v5780.js?v=5802',
  './js/studio-locked-ui-v5780.js?v=5802',
  './js/studio-polish-v5782.js?v=5802',
  './js/studio-release-v5789.js?v=5802',
  './js/studio-release-v5787.js?v=5802',
  './js/studio-release-v5788.js?v=5802',
  './js/studio-release-v5790.js?v=5802',
