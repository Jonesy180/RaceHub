const CACHE_NAME='racehub-v5.9.3-synchronized-beta-fixes';
const ASSETS=[
  './','./index.html','./style-v593.css?v=593','./manifest.webmanifest?v=5829','./favicon.png',
  ...
  './js/studio-race-flow-v5809.js?v=5829','./js/bootstrap-v593.js?v=593','./js/studio-race-end-v5837.js?v=5837',
